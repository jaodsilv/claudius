#!/bin/bash
# Post-review handler: posts review to PR and updates metadata
...
if [[ -z "$PR_NUMBER" ]] || [[ "$PR_NUMBER" == "null" ]]; then
  log_error "PR number not found in metadata"
...
log_info "Review posted and metadata updated"
