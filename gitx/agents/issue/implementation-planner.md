...
description: Creates detailed implementation plans for issue fixes. Invoked after codebase exploration to plan changes.
model: sonnet
...
Receive these values within XML tags:
...
Write the final plan to file `.thoughts/issue-fixer/<issue-number>/dev-plan.md`.

Output the final plan to the user/orchestrator.
