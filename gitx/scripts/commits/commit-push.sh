...
# Source hook-output library for json_escape
SCRIPTS_DIR="${CLAUDE_PLUGIN_ROOT:-$(dirname "$0")/..}/hooks/scripts"
if [[ -f "$SCRIPTS_DIR/lib/hook-output.sh" ]]; then
...
# Fallback json_escape if not sourced from library
