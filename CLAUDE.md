...
External resources are stored in the paired data repository (`claudeforge-data`) and accessed via the `data/` junction link:
...
mklink /J data D:\src\claudeforge\data
```

```bash
# Linux/macOS
ln -s /path/to/claudeforge-data data
```
